    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gotoCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(CurrentOrder.this,CartActivity.class);
                startActivity(i);
            }
        });
        ...
        judul.setText("Current Orders");

        // not used Button back=(findViewById(R.id.oback));
        // not usedback.setOnClickListener(new View.OnClickListener() {
        // not used    @Override
        // not used public void onClick(View v) {
        // not used    Intent i=new Intent(CurrentOrder.this,MainActivity.class);
        // not used     startActivity(i);
        // not used  }
        // not used});

        // not used   FloatingActionButton c_fab=(FloatingActionButton)findViewById(R.id.c_fab);
        // not used    c_fab.setOnClickListener(new View.OnClickListener() {
        // not used      @Override
        // not used     public void onClick(View view) {
    ...
    public class AsyncGet extends AsyncTask<String, String, String>
    {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("http://apikyancafe.flaviary.online/displaycurrentorders.php?email="+email);
...
//            }
        ...
        protected void onPostExecute(String result) {
            ...
            //not used if(itemslist.size()==0 || response=="[]")
            //not used{
            //not used  Intent i=new Intent(CurrentOrder.this,OrderHistory.class);
            //not used  startActivity(i);
            //not used }
