...
public class DessertListActivity extends AppCompatActivity {
    ...
    private static ArrayList<DessertItemDataModel> data;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.menulistrecycler3);
        recyclerView.setHasFixedSize(true);

        layoutManager = new LinearLayoutManager(this);
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setItemAnimator(new DefaultItemAnimator());
        DessertListActivity.AsyncGet obj=new DessertListActivity.AsyncGet();
        obj.execute();
...
*/
       /* FloatingActionButton m_fab=(FloatingActionButton)findViewById(R.id.m_fab);
        ...
        gotoCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(DessertListActivity.this,CartActivity.class);
                startActivity(i);
            }
        });
        ...
        backIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(DessertListActivity.this,MenuListActivity.class);
                startActivity(i);
            }
        });
        judul.setText("Desserts");
        ...
        foodsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(DessertListActivity.this, MenuListActivity.class));
            }
        });

        Button drinksButton = (Button)findViewById(R.id.drinkButton);

        drinksButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(DessertListActivity.this, DrinkListActivity.class));
            }
        });
    ...
    {
        ProgressDialog pdLoading = new ProgressDialog(DessertListActivity.this);
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                // Enter URL address where your php file resides
                 url = new URL("http://apikyancafe.flaviary.online/dessert.php");
                //url = new URL(LoginActivity.weburl+"dessert.php");
        ...
        protected void onPostExecute(String result) {
            ...
            data=DessertItemDataModel.fromJson(jsonArray);
            adapter=new MenuItemAdapter3(context,data);
            ...
            if(result!=null)
            {
                ...
                Toast.makeText(DessertListActivity.this, "Items Fetched successfully", Toast.LENGTH_LONG).show();

            }else{

                // If username and password does not match display a error message
                Toast.makeText(DessertListActivity.this, "Fetching Failed.", Toast.LENGTH_LONG).show();
