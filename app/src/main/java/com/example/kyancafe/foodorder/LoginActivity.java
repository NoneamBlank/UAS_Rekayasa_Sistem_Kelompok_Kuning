...
public class LoginActivity extends AppCompatActivity {
    ...
    public static String weburl="http://192.168.100.7/foodorder/customer/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean isNetwork = activeNetwork != null && activeNetwork.isConnected();

        if(isNetwork){

        } else {
            final Dialog dialog = new Dialog(LoginActivity.this, android.R.style.Theme_NoTitleBar_Fullscreen);
            dialog.setContentView(R.layout.connection_dialog);
            dialog.show();

            Button btn_enablewifi = dialog.findViewById(R.id.btn_enablewifi);
            btn_enablewifi.setOnClickListener(new View.OnClickListener() {
                @Override
    ...
    private class AsyncLogin extends AsyncTask<String, String, String>
    {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("http://apikyancafe.flaviary.online/login.php");
