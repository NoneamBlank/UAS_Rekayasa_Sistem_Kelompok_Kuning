...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // not used LinearLayout orderhistory=(LinearLayout)findViewById(R.id.l_orderhistory);
        // not used LinearLayout suggested=(LinearLayout)findViewById(R.id.l_suggested);
        ...
        //not used orderhistory.setOnClickListener(new View.OnClickListener() {
            //@Override
            //public void onClick(View v) {
        ...
        //not used suggested.setOnClickListener(new View.OnClickListener() {
            //@Override
            //public void onClick(View v) {
