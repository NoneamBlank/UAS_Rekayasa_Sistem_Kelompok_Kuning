...
public class MenuItemAdapter2 extends RecyclerView.Adapter<MenuItemAdapter2.MenuItemViewHolder2>
{
    Context context;
    ArrayList<DrinkItemDataModel> data;

    public MenuItemAdapter2(Context context,ArrayList<DrinkItemDataModel> data) {
        this.data = data;
    ...
    @NonNull
    @Override
    public MenuItemViewHolder2 onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.drink_list_item, parent, false);
        MenuItemViewHolder2 myViewHolder2 = new MenuItemViewHolder2(view);
    ...
    @Override
    public void onBindViewHolder(@NonNull MenuItemViewHolder2 holder, int position) {
    ...
    public static class MenuItemViewHolder2 extends RecyclerView.ViewHolder
    {
        TextView itemname;
        TextView itemprice;
        Button additem;
        ...
        public MenuItemViewHolder2(View itemView) {
            super(itemView);
