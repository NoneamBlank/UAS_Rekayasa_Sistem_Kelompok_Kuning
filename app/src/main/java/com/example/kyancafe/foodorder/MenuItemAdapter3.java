...
public class MenuItemAdapter3 extends RecyclerView.Adapter<MenuItemAdapter3.MenuItemViewHolder3>
{
    Context context;
    ArrayList<DessertItemDataModel> data;

    public MenuItemAdapter3(Context context,ArrayList<DessertItemDataModel> data) {
        this.data = data;
    ...
    @NonNull
    @Override
    public MenuItemViewHolder3 onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.dessert_list_item, parent, false);
        MenuItemViewHolder3 myViewHolder3 = new MenuItemViewHolder3(view);
    ...
    @Override
    public void onBindViewHolder(@NonNull MenuItemViewHolder3 holder, int position) {
        ...
        additem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(qty.getText().toString().equals("0"))
                {
                    ...
                    String url="http://apikyancafe.flaviary.online/cart.php";
    ...
    public static class MenuItemViewHolder3 extends RecyclerView.ViewHolder
    {
        TextView itemname;
        TextView itemprice;
        Button additem;
        ...
        public MenuItemViewHolder3(View itemView) {
            super(itemView);
