       ...
       /* FloatingActionButton m_fab=(FloatingActionButton)findViewById(R.id.m_fab);
        ...
        gotoCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(MenuListActivity.this,CartActivity.class);
                startActivity(i);
            }
        });
        ...
        drinksButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MenuListActivity.this, DrinkListActivity.class));
            }
        });
        ...
        dessertsButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(MenuListActivity.this, DessertListActivity.class));
            }
        });
    ...
    private class AsyncGet extends AsyncTask<String, String, String>
    {
        ...
        protected String doInBackground(String... params) {
            try {
               ...
               url = new URL("http://apikyancafe.flaviary.online/menu.php");
